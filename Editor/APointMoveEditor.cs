...
[CustomEditor(typeof(APointMove))]
public class MovingPlatformEditor : Editor
{
    APointMove m_MovingPlatform;
    ...
    {
        m_PreviewPosition = 0;
        m_MovingPlatform = target as APointMove;
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUI.BeginChangeCheck();
        APointMove.MovingPlatformType platformType = (APointMove.MovingPlatformType)EditorGUILayout.EnumPopup("Looping", m_MovingPlatform.platformType);
        if (EditorGUI.EndChangeCheck())
        {
    ...
    private void OnSceneGUI()
    {
        ...
        for (int i = 0; i < m_MovingPlatform.localNodes.Length; ++i)
        {
            ...
            if (i == 0)
            {
                if (m_MovingPlatform.platformType != APointMove.MovingPlatformType.LOOP)
                    continue;
